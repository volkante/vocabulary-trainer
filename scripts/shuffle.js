...
export function shuffle(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    randomNumArr.push(createRandomNum(arr, randomNumArr));
  }
  console.log(randomNumArr);
  // Iterate over the turkish words to sort them randomly
  createOutput(arr, randomNumArr);
  return shuffledArr;
}

/* ***************** Create output function **************** */
function createOutput(turkishWordsArr, randomNumArr) {
...
function createRandomNum(turkishWordsArr, randomNumArr) {
